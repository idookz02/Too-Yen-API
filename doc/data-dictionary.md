...
| description | TEXT | YES | | คำบรรยายสูตร บังคับตอน publish / Recipe description, required at publish (app-enforced) |
...
| cooking_method_id | BIGINT | YES | FK → master_cooking_method | วิธีปรุง / Cooking method |
